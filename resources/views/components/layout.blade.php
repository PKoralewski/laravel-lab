...
<body>
    ...
    <nav class="bg-gray-800">
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div class="relative ml-3">
                    <div>
                        ...
                        <img class="size-8 rounded-full" src="https://laracasts.com/images/lary-ai-face.svg" alt="Profile image">
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            ...
            <div class="shrink-0">
                <img class="size-10 rounded-full" src="https://laracasts.com/images/lary-ai-face.svg" alt="Profile image">
            </div>
            <div class="ml-3">
